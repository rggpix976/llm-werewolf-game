...
- Completed the default-off Migration Phase 5 Draft implementation for browser/CLI structured display and history using exact `PlayerLegacyDisplayCompatibilityRecord` resolution; position-, phase-, FIFO-, and message-based legacy replacement were removed.
