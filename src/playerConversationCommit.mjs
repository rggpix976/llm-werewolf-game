...
export function preparePlayerConversationCommit({ state, binding, alternative, targetNpcId, createId, fault = () => {} }) {
  ...
  validateCommittedConversationGraph({ gameSessionId: state.gameSessionId, inputRecords: [...existing.inputRecords, inputRecord], acceptedSpeechActs: [...existing.acceptedSpeechActs, ...acts], claims: [...existing.claims, ...claims], events: [...existing.events, ...events], displayPlans: [...existing.displayPlans, displayPlan], reactionPlans: existing.reactionPlans, publications: [...existing.publications, publication], playerLegacyDisplayCompatibilityRecords: [...existing.playerLegacyDisplayCompatibilityRecords, compatibilityMapping], commitResults: [...existing.commitResults, result], idempotencyRecords: existing.idempotencyRecords, npcReactionCommitIdempotencyRecords: existing.npcReactionCommitIdempotencyRecords, legacyPlayerLog: [...state.playerLog, legacyPlayerLogEntry] }); fault("committed_graph");
