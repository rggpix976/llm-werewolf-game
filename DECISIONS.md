...
## D-012: Provider-Generated Text Is Untrusted

NPC response text generated by any provider (LLM or pseudo) is considered untrusted until it passes the deterministic **Utterance Guard**.

Rejected text is never displayed to players, stored in logs, or included in diagnostics. It is replaced locally by a deterministic pseudo-response generated from the code-approved factual basis (`responsePlan.baseText`). This replacement is performed without making any additional LLM requests.
